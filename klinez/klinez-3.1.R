...
# example
table(dating$respondent_education)
table(dating$partner_education)
...
########## Example
table(dating$respondent_education , dating$partner_education)
...
chisq.test(table(dating$respondent_education , dating$partner_education))
